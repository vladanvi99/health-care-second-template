...
//NEWS DETAILS
if(document.querySelector("#news_details")){
  let relatedBtn = document.querySelector("#news_details .related-news-btn")
  let popularBtn = document.querySelector("#news_details .popular-news-btn")

  let relatedWrap = document.querySelector("#news_details .related-news-post-wrap")
  let popularWrap = document.querySelector("#news_details .popular-news-post-wrap")
